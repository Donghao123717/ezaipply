      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: 'nationalIdNumber', labelKey: 'ds160.personal1.nationalIdNumber', type: 'text', notApplicable: 'doesNotApply' },
            { key: 'usSSN', labelKey: 'ds160.personal1.usSSN', type: 'text', notApplicable: 'doesNotApply' },
            { key: 'usTaxpayerId', labelKey: 'ds160.personal1.usTaxpayerId', type: 'text', notApplicable: 'doesNotApply' },
          ],
        },
      ],
      nestedRepeatables: [
      ...
      groups: [
        ...
        },
        {
          ...
          fields: [
            ...
            { key: 'payerEmail', labelKey: 'ds160.travel.payerEmail', type: 'text', notApplicable: 'doesNotApply' },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: 'payerStateProvince', labelKey: 'ds160.travel.payerStateProvince', type: 'text', notApplicable: 'doesNotApply' },
            { key: 'payerPostalCode', labelKey: 'ds160.travel.payerPostalCode', type: 'text', notApplicable: 'doesNotApply' },
      ...
      groups: [
        {
          fields: [
            ...
            { key: 'visaNumber', labelKey: 'ds160.previousTravel.visaNumber', type: 'text', notApplicable: 'doNotKnow' },
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: 'homeStateProvince', labelKey: 'ds160.addressPhone.stateProvince', type: 'text', notApplicable: 'doesNotApply' },
            { key: 'homePostalCode', labelKey: 'ds160.addressPhone.postalCode', type: 'text', notApplicable: 'doesNotApply' },
  ...
  },
  {
    ...
    def: {
      ...
      groups: [
        {
          fields: [
            { key: 'contactSurname', labelKey: 'ds160.usContact.contactSurname', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'contactGivenNames', labelKey: 'ds160.usContact.contactGivenNames', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'organizationName', labelKey: 'ds160.usContact.organizationName', type: 'text', notApplicable: 'doNotKnow' },
    ...
    def: {
      ...
      groups: [
        ...
        },
        {
          ...
          fields: [
            { key: 'fatherSurnames', labelKey: 'ds160.familyInfo.fatherSurnames', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'fatherGivenNames', labelKey: 'ds160.familyInfo.fatherGivenNames', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'fatherDob', labelKey: 'ds160.familyInfo.fatherDob', type: 'date', notApplicable: 'doNotKnow' },
        ...
        },
        {
          ...
          fields: [
            { key: 'motherSurnames', labelKey: 'ds160.familyInfo.motherSurnames', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'motherGivenNames', labelKey: 'ds160.familyInfo.motherGivenNames', type: 'text', notApplicable: 'doNotKnow' },
            { key: 'motherDob', labelKey: 'ds160.familyInfo.motherDob', type: 'date', notApplicable: 'doNotKnow' },
      ...
      groups: [
        {
          fields: [
            ...
            { key: 'stateProvince', labelKey: 'ds160.presentWork.stateProvince', type: 'text', notApplicable: 'doesNotApply' },
            { key: 'postalCode', labelKey: 'ds160.presentWork.postalCode', type: 'text', notApplicable: 'doesNotApply' },
