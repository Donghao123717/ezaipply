...
export function SchoolSearch({
  ...
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-1">School search</p>
      <h2 className="font-semibold text-primary flex items-center gap-1.5 mb-1">
        <GraduationCap className="h-4 w-4" />
        Add schools
      </h2>
      <p className="text-sm text-muted-foreground mb-3">Already-added schools live in your list above.</p>
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs text-muted-foreground">{results.length} schools to add</span>
        <button
